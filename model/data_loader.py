...
class DataLoader(object):
    ...
    def __init__(self, data_dir, params):
        ...
        self.tag_map = {}
        with open(tags_path, encoding="utf8", errors='ignore') as f:
    ...
    def load_sentences_labels(self, sentences_file, labels_file, d):
        ...
        with open(sentences_file, encoding="utf8", errors='ignore') as f:
        ...
        with open(labels_file, encoding="utf8", errors='ignore') as f:
            for sentence in f.read().splitlines():
